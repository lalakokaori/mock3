...
<!--**********************************-->
<div class="row" style="padding-top: 25px;">s
                <div class="col-md-12" >
                    <h4 class="page-head-line">Equipment</h4>
                        ...
                        <div class="panel-body">
                            ...
                            <button onclick="window.location.href='../../../view/report/daily/material.php'" class="btn btn-primary btn-lg">
                              Material 
                            </button>
                            <button onclick="window.location.href='../../../view/report/daily/equipment.php'" class="btn btn-primary btn-lg">
                              Equipment 
                            </button>
                            <button onclick="window.location.href='../../../view/report/daily/manpower.php'" class="btn btn-primary btn-lg">
                              Manpower 
                            </button>
            </div>
                </div>
