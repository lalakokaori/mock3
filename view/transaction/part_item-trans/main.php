                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                      ...
                                      <div class="col-sm-4 col-xs-12" id="f_part_div" class='form-group'>
                                        ...
                                        <div class="col-sm-6 col-xs-12" id="f_percent_subcat_div" class='form-group'>
                                                <label><font color="darkred">*</font>Percent</label> <!-- MODEL -->
                                        ...
                                        <div class="modal-footer">
                                        <div class="col-md-4" >  <br><button id="btn_reset1" class="btn btn-block btn-primary btn-lg"">Reset</button></div>
